//package africa.semicolon.RealtyHub.Security.Filters;
//
...
//import static africa.semicolon.RealtyHub.utils.ExceptionUtils.AUTHENTICATION_FAILED_FOR_USER_WITH_EMAIL;
...
//@Component
//public class RealtyHubAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
...
//            LoginUserRequest loginRequest = mapper.readValue(request.getInputStream(), LoginUserRequest.class);
