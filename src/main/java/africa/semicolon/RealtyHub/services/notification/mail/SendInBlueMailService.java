...
import africa.semicolon.RealtyHub.config.MailConfig;
...
import static africa.semicolon.RealtyHub.utils.AppUtils.API_KEY_VALUE;
import static africa.semicolon.RealtyHub.utils.AppUtils.EMAIL_URL;

@Service
@AllArgsConstructor
@Slf4j
public class SendInBlueMailService implements MailServices{
    ...
    public SendMailResponse sendMail(EmailNotificationRequest emailNotificationRequest) {
        ...
        RequestEntity<EmailNotificationRequest> entity = new RequestEntity<>(
        emailNotificationRequest, httpHeaders, HttpMethod.POST, URI.create(EMAIL_URL));
